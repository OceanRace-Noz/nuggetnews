...
export const EmailSignupForm: React.FC<EmailSignupFormProps> = ({ className }) => {
  ...
  return (
    <form 
      ...
      className={`flex flex-col items-center gap-4 border shadow-[0px_0px_12px_0px_rgba(234,174,51,0.55)] bg-[rgba(29,29,29,0.5)] p-6 rounded-[50px] border-solid border-[#C7881F] w-full max-w-[600px] ${className}`}
