  ...
  return (
    <div className="px-6 md:px-0 w-full">
      <form 
        ...
        className={`flex flex-row items-center justify-between gap-2 border bg-[rgba(29,29,29,0.5)] p-2 rounded-[50px] border-solid border-[#C7881F] w-full max-w-[600px] mx-auto shadow-[0px_0px_12px_0px_rgba(234,174,51,0.55)] hover:shadow-[0px_0px_12px_0px_rgba(234,174,51,0.75)] transition-shadow ${className}`}
