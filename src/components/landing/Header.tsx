...
export const Header: React.FC<HeaderProps> = ({ className }) => {
  return (
    ...
    >
      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/3cdecd34ea3c5a897195254b4326a771dabb57fc?placeholderIfAbsent=true" alt="Nugget logo" className="w-[272px] h-[75px]" />
